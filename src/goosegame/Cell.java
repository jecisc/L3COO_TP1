...
/**
 * Interface for the cell of the goose game. 
 * Note that there can be only one player by cell, the starting cell (index 0) excepted.
 */
public interface Cell {
	 ...
	 * 
	 * @return true if and only if the only was for a player to get out of this cell is for another player to replace him.
	 */
	 ...
	 * For normal cells, the returned value equals
	 * <code>getIndex()</code> and is thus independent from <code>diceThrow</code>.
	 * 
	 * @param diceThrow
